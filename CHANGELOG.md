...
- Storage bumped to **v6** with a deterministic, non-destructive migration. New store keys: `profile_groups`, `matching_config`, per-cycle `ml_review`, on-device `ml_model_versions`, and a "golden" flag on recorded cycles.
