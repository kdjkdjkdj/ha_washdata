...
| `cycle_detector.py` | 1968 | The `OFF -> STARTING -> RUNNING <-> PAUSED -> ENDING -> OFF` state machine (+ delayed-start, anti-wrinkle, dishwasher end, ML end-guard hook, terminal-drop hook). | [01](reference/01-detection-core.md) |
